...
export const NL = { code: 'nl_NL', language: 'Nederlands' }
export const FIL = { code: 'fil', language: 'Filipino' }
export const FI = { code: 'fi', language: 'Suomalainen' }
export const FR = { code: 'fr_FR', language: 'Français' }
...
export const JA = { code: 'ja_JP', language: '日本語' }
...
export const TR = { code: 'tr_TR', language: 'Türkçe' }
